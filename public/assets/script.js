...
const start_delivery_date=document.querySelector("start-delivery-date")
if(start_delivery_date)document.getElementById("start-delivery-date").innerHTML = $short_start_date;
...
document.getElementById('dark-mode-toggle').addEventListener('click', function() {
  // Toggle dark mode by adding/removing classes on the body element
